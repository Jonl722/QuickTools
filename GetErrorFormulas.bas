...
Private Sub GetErrorFormulas( _
    ...
    Do
        ...
        If rformula.Errors(xlUnlockedFormulaCells).Value = True Then Set pr_xlUnlockedFormulaCells = p_sheet.Application.Union(pr_xlUnlockedFormulaCells, rformula)
        If rformula.Errors(xlInconsistentFormula).Value = True Then Set pr_xlInconsistentFormula = p_sheet.Application.Union(pr_xlInconsistentFormula, rformula)
        If rformula.Errors(xlInconsistentListFormula).Value = True Then Set pr_xlInconsistentListFormula = p_sheet.Application.Union(pr_xlInconsistentListFormula, rformula)
